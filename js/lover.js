...
function man() {
  ...
  document.getElementById("manq2").style.transform =
    "rotateZ(-" + deg1 + "deg)";
}
...
function flower1() {
  ...
  if (flower1num > 9) {
    twyuan();
    fireworks();
    document.getElementById("twyuan0").style.transform =
      "rotateZ(" + rdmnum1 + "deg)";
    document.getElementById("twyuan1_0").style.transform =
      "rotateZ(" + rdmnum2 + "deg)";
    document.getElementById("twyuan2_0").style.transform =
      "rotateZ(" + rdmnum3 + "deg)";
    document.getElementById("twyuan3_0").style.transform =
      "rotateZ(" + rdmnum4 + "deg)";
    document.getElementById("twyuan4_0").style.transform =
      "rotateZ(" + rdmnum5 + "deg)";
    document.getElementById("twyuan5_0").style.transform =
      "rotateZ(" + rdmnum6 + "deg)";
...
function fireworks() {
  for (var i = 0; i < 10; i++) {
    document.getElementById("twyuan4_" + i).innerHTML =
      '<div class="twyuan4_' +
      (i + 1) +
      '" id="twyuan4_' +
      (i + 1) +
    ...
    document.getElementById("twyuan3_" + i).innerHTML =
      '<div class="twyuan3_' +
      (i + 1) +
      '" id="twyuan3_' +
      (i + 1) +
    ...
    document.getElementById("twyuan2_" + i).innerHTML =
      '<div class="twyuan2_' +
      (i + 1) +
      '" id="twyuan2_' +
      (i + 1) +
    ...
    document.getElementById("twyuan1_" + i).innerHTML =
      '<div class="twyuan1_' +
      (i + 1) +
      '" id="twyuan1_' +
      (i + 1) +
    ...
    document.getElementById("twyuan" + i).innerHTML =
      '<div class="twyuan' +
      (i + 1) +
      '" id="twyuan' +
      (i + 1) +
    ...
    document.getElementById("twyuan5_" + i).innerHTML =
      '<div class="twyuan5_' +
      (i + 1) +
      '" id="twyuan5_' +
      (i + 1) +
...
function heartss() {
  heartsnum++;
  if (heartsnum == 4) {
    document.getElementById("heart1").style.boxShadow =
      "0px 0px 100px 10px red";
    document.getElementById("heart2").style.boxShadow =
      "0px 0px 100px 10px red";
    document.getElementById("heart3").style.boxShadow =
      "0px 0px 100px 10px red";
  }
  if (heartsnum > 4) {
...
function yanhuas() {
  ...
  if (yhnum == 6) {
    ...
    document.getElementById("yanhua").innerHTML =
      '<div class="yh1" id="yh1" style="background-color: hsla(' +
      rdm1num +
      ',100%,50%,1);"><div class="yh2" id="yh2" style="background: radial-gradient(transparent, hsla(' +
      rdm1num +
      ",100%,50%,1)); box-shadow: 0px 0px 100px 1px hsla(" +
      rdm1num +
      ",100%,50%,1);border-color: hsla(" +
      rdm1num +
      ',100%,50%,1);"></div></div>';
    document.getElementById("yanhua2").innerHTML =
      '<div class="yh21" id="yh21" style="background-color: hsla(' +
      rdm2num +
      ',100%,50%,1);"><div class="yh22" id="yh22" style="background: radial-gradient(transparent, hsla(' +
      rdm2num +
      ",100%,50%,1)); box-shadow: 0px 0px 100px 1px hsla(" +
      rdm2num +
      ",100%,50%,1);border-color: hsla(" +
      rdm2num +
      ',100%,50%,1);"></div></div>';
    document.getElementById("yanhua3").innerHTML =
      '<div class="yh31" id="yh31" style="background-color: hsla(' +
      rdm5num +
      ',100%,50%,1);"><div class="yh32" id="yh32" style="box-shadow: 0px 0px 100px 1px hsla(' +
      rdm5num +
      ",100%,50%,1);border-color: hsla(" +
      rdm5num +
      ",100%,50%,1);background: radial-gradient(transparent, hsla(" +
      rdm5num +
      ',100%,50%,1));"></div></div>';
    yhnum = 0;
  }
...
function coordinate(event) {
  ...
  var x = event.clientX;
  var y = event.clientY;
  document.getElementById("dibu").innerHTML =
    "<div class='ys' id='ys' style='top: " +
    y +
    "px;left: " +
    x +
    "px;'></div>";
...
function clickxgt() {
  ...
  document.getElementById("ys").style.top =
    document.getElementById("ys").offsetTop - 50 + "px";
  document.getElementById("ys").style.left =
    document.getElementById("ys").offsetLeft - 50 + "px";
...
function text2() {
  for (var i = 0; i < str.length; i++) {
    document.getElementById("text2").innerHTML +=
      '<div id="textss' +
      i +
      '" style="opacity: 0;transition: 0.5s;float:left;">' +
      str[i] +
      "</div>";
  }
}
...
function kks() {
  for (var i = 1; i <= 24; i++) {
    document.getElementById("kk" + i).style.transform =
      " rotateY(" + deg4 + "deg) translateZ(600px)";
    deg4 += 15;
  }
}
