...
function door() {
  switch (num1) {
    case 0:
      ...
      document.getElementById("door_down").style.boxShadow =
        "0px 0px 1000px 500px #fff";
...
function ps() {
  ...
  document.getElementById("textp").innerHTML = "Behind the door is the unknown, do you want to... open the door?";
...
function ps1() {
  ...
  document.getElementById("textp").innerHTML =
    "Want to... go in? Maybe fear, maybe something terrible is behind...";
...
function closeDoor() {
  ...
  var b1_x = Math.ceil(
    document.getElementById("door_all").getBoundingClientRect().left
  );
  var b1_y = Math.ceil(
    document.getElementById("door_all").getBoundingClientRect().top
  );
...
function texts() {
  ...
  if (tnum == 8) {
    ...
    document.getElementById("music").src = "music/Romantic Confession Piano Score.mp3";
